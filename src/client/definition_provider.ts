...
export class SolidworksEquationsDefinitionProvider
  implements vscode.DefinitionProvider
{
  public async provideDefinition(
    ...
    const leadingCharacter = document.getText(
      new vscode.Range(
        new vscode.Position(range.start.line, startCharacter - 1),
    ...
    const trailingCharacter = document.getText(
      new vscode.Range(
        new vscode.Position(range.end.line, endCharacter),
        new vscode.Position(range.end.line, endCharacter + 1)
      )
    );
